<!-- MOBILE MENU -->
        ...
        <div class="ed-mob-menu">
            <div class="ed-mob-menu-con">
                <div class="ed-mm-left">
                    <div class="wed-logo">
                        <a href="index-1.html"><img src="images/a1.png" alt="" />
						</a>
                    </div>
                </div>
    ...
    <section>
        ...
        <div class="top-logo" data-spy="affix" data-offset-top="250" style="padding:0px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="wed-logo">
                            <a href="index-1.html"><img src="images/a1.png" alt="" height="90px"/>
                            </a>
                        </div>
                        <div class="main-menu" style="margin-top:10px;">
                            <ul>
                                        ...
                                        <div class="admi-mm m-menu">
                                            <div class="m-menu-inn">
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="course-details.html">
                                                    ...
                                                    <a href="course-details.html" class="mm-r-m-btn">Read more</a>
                                                </div>
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="course-details.html">
								...
								<li class="cour-menu">
                                    <a href="all-courses.html" class="mm-arr">Interviews(Q&A)</a>
                                    <!-- MEGA MENU 1 -->
                                    <div class="mm-pos">
                                ...
                                <li class="cour-menu">
                                    <a href="all-courses.html" class="mm-arr">All Courses</a>
                                    <!-- MEGA MENU 1 -->
                                    <div class="mm-pos">
                                        <div class="cour-mm m-menu">
                                            <div class="m-menu-inn">
								...
								<li class="about-menu">
                                    <a href="about.html" class="mm-arr">Student Zone</a>
                                    <!-- MEGA MENU 1 -->
                                    <div class="mm-pos">
                                        <div class="about-mm m-menu">
                                            <div class="m-menu-inn">
                                ...
                                <li><a href="events.html">Batches</a>
                                </li>
