...
<head>
    <title>Experience Interviews</title>
    <!-- META TAGS -->
    <meta charset="utf-8">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="cor-con-mid">
                            ...
                            <div class="cor-p5">
                                ...
                                <?php
                                require_once('db.php');
                                $result = $conn->prepare("SELECT * FROM interviewjobs WHERE ModeOfJobIntern = 'Experience'");
                                $result->execute();
